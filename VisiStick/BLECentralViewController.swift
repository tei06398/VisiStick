...
class BLECentralViewController : UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate, UITableViewDelegate, UITableViewDataSource{
    ...
    func centralManagerDidUpdateState(_ central: CBCentralManager) {
        if central.state == CBManagerState.poweredOn {
            ...
            print("Bluetooth is Disabled. Please make sure your Bluetooth is turned on.")
            
            let alertVC = UIAlertController(title: "Bluetooth is Disabled", message: "Please make sure your Bluetooth is turned on.", preferredStyle: UIAlertControllerStyle.alert)
